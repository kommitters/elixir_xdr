defmodule Error.HyperUIntTest do
  use ExUnit.Case

  alias XDR.Error.HyperUInt

  test "When receives :not_integer" do
    assert_raise HyperUInt, "The value which you try to encode is not an integer", fn ->
      raise HyperUInt, :not_integer
    end
  end

  test "When receives :not_binary" do
    assert_raise HyperUInt,
                 "The value which you try to decode must be a binary value, for example: <<0, 0, 0, 0, 0, 0, 0, 5>>",
                 fn ->
                   raise HyperUInt, :not_binary
                 end
  end
  ...
  test "When receives :exceed_upper_limit" do
    assert_raise HyperUInt,
                 ...
                 fn ->
                   raise HyperUInt, :exceed_upper_limit
                 end
  end
  ...
  test "When receives :exceed_lower_limit" do
    assert_raise HyperUInt,
                 ...
                 fn ->
                   raise HyperUInt, :exceed_lower_limit
                 end
  end
end
